...
/**
 * Une classe de base pour implementer l'index. Cette classe vérifie et
 * certifie que l'index n'est pas dans un etat inadmissible lorsqu'on effectue
...
public abstract class IndexBase<T> implements Index<T> {
    ...
    *
    * @throws IndexException
    *            if an error occurs while clearing all records.
    */
    ...
    *           records to add.
    * @throws IndexException
    *            if an error occurs while adding the records.
    */
   protected abstract void doAdd(Iterator<Record<T>> records)
         throws IndexException;
    ...
    *            if an error occurs while removing the record.
    */
   protected abstract void doRemove(Iterator<Record<T>> records)
         throws IndexException;
    ...
    * @throws IndexException
    *            if an error occurs while reading the size.
    */

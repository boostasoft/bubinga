...
import com.boostasoft.goaway.tilingDB.datastructure.hexaTree.TransmittedNode;
...
public class Node {
    ...
    public Node(String sridParam, ScaleInfo scaleParam, String signatureParam,
            String tableNameParam, int tableIdParam) {
        super();
        this.signature = signatureParam;
        this.srid = sridParam;
        this.scale = scaleParam;
    ...
    public Node(String sridParam, ScaleInfo scaleParam, String signatureParam,
            String tableNameParam, int tableIdParam,
            TransmittedNode transmittedInfoParam,String ontologyName, String OntologyPathParam, String entityInfoParam) {
        super();
        this.signature = signatureParam;
        this.srid = sridParam;
        this.scale = scaleParam;
        ...
        transmittedInfo= transmittedInfoParam;
        this.ontologyName=ontologyName;
        this.OntologyPath=OntologyPathParam;
        this.entityInfo=entityInfoParam;

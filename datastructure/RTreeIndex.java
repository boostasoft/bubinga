package com.boostasoft.goaway.tilingDB.datastructure;
...
public class RTreeIndex extends SpatialIndex {
    ...
    public Iterator<Record<Geometry>> globalquery(final Geometry value, Operation operation) {
    	
    	
    	 return iterator(value, operation);
    }

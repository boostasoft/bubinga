...
//   public String getURI();
   ...
   public static class OperationIterator implements
   ...
   public static class MatrixTester extends Operation {
      ...
      public MatrixTester(MatrixTester... values) {
         ...
         for (MatrixTester m : values) {
            for (IntersectionMatrix im : m.getIntersectionMatrices()) {
               matrices.add(im);
            }
         }
         this.matrices = matrices.toArray(new IntersectionMatrix[] {});
...
//      public static final Operation COVERS = new MatrixTester("T*TFT*FF*");
...
//      public static final Operation COVEREDBY = new MatrixTester("TFF*TFT**");

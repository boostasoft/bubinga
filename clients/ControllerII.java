...
import com.boostasoft.goaway.tilingDB.datastructure.hexaTree.HexaTree;
import com.boostasoft.goaway.tilingDB.datastructure.hexaTree.HexaTreeIndex;
import com.boostasoft.goaway.tilingDB.datastructure.management.HexaTreeMultiLevel;
import com.boostasoft.goaway.tilingDB.datastructure.management.ManageHexaTreeMultiLevel;
...
import com.boostasoft.goaway.tilingDB.util.ScaleInfoUtil;
...
public class ControllerII extends Thread {
    ...
    protected  String Directory = "C:/Users/dtsatcha/Desktop/IGN/java/tiling-geoxygene-mapping/src/main/java/fr/ign/cogit/mapping/clients/spatial";
    /*
     ...
     */
    public ControllerII(Converter ConvertisseurParam,String Directory) {
        super();

        Convertisseur = ConvertisseurParam;
        this.Directory=Directory;
        controlI = new ControllerI(this.Directory);
        ...
        HexaTreeMultiLevel hexaTreemultilevel = new HexaTreeMultiLevel(
			...
			managerHex = new ManageHexaTreeMultiLevel(hexaTreemultilevel,
					this.directory, Convertisseur, controlI.getManager());
    ...
    public ControllerII(Converter ConvertisseurParam, ScaleInfo Scaleinfo, String 
    		 Directory) {
        super();
    ...
    public List<Record<Geometry>> searchGeoFromCadrage(ScaleInfo scaleinfo,
        ...
        if (it != null) {
            while (it.hasNext()) {
                ...
                com.boostasoft.goaway.tilingDB.datastructure.Node node = content.getKey();
